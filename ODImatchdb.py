...
def insert_match_info(data):
    ...
    INSERT INTO MatchInfo (
        match_id, city, venue, match_type, match_number, season, event_name, 
        toss_winner, toss_decision, winner, win_by_runs, player_of_match, balls_per_over
...
# Process JSON file
data_folder = "C:\\Users\\prasi\\Cricsheet\\odis_json"  # Replace with your folder path
